...
map.getView().fit([8468854.127461, 1299436.563780, 8497835.520584, 1317846.148090], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MEENANGADY</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (172 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'THIS IS A ELABORATED MAP OF MEENANGADY PANCHAYATH WHICH INCLUDES DETAILED INFORMATION ABOUT THE RESOURCE OF THIS PARTICULAR PANCHAYTH SUCH AS ANGANAVADY,COMMUNITY HALL ETC.';
            }
